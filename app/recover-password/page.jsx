      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form action={action}>
          ...
          <div>
                      ...
                      <input type="email"  name="email" id="email" className="border border-gray-300 rounded-md px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="name@company.com"  />
